...
const NavBar = () => {
    ...
    const getNavItems = (role) => {
        const navItems = {
            ...
            customer: [
                { name: 'Home', href: '/homepage', icon: <AiOutlineHome className="mr-2" /> },
                { name: 'Products', href: '/customers/product', icon: <AiOutlineShoppingCart className="mr-2" /> },
                { name: 'Cart', href: '/customers/cart', icon: <AiOutlineShoppingCart className="mr-2" /> },
                { name: 'Orders', href: '/customers/order', icon: <FaFileAlt className="mr-2" /> },
            ],
            // Employee routes
            employee: [
                { 
            ...
            // Delivery routes
            delivery: [
                { name: 'Dashboard', href: '/delivery/delivery_home', icon: <AiOutlineHome className="mr-2" /> },
                { name: 'Assign Drivers', href: '/delivery/assign_driver', icon: <FaUserClock className="mr-2" /> },
                { name: 'Add Driver', href: '/delivery/add_driver', icon: <FaUserClock className="mr-2" /> },
                { name: 'Delivery Status', href: '/delivery/delivery_status', icon: <FaChartBar className="mr-2" /> },
                { name: 'Delivery Reports', href: '/delivery/delivery_reports', icon: <FaFileAlt className="mr-2" /> },
            ],
            // Financial routes
            finance: [
