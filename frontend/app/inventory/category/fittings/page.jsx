      ...
      if (storedItems) {
        ...
        if (Array.isArray(parsedItems)) {
          ...
          const fittingItems = parsedItems.filter(item => 
            ...
            item.category === 'Fittings' ||
            (item.name && item.name.toLowerCase().includes('fitting'))
          );
          ...
          return fittingItems.map(item => ({
            ...
            image: item.image || 'https://img.freepik.com/free-photo/tools-materials-sanitary-works_93675-132625.jpg?t=st=1745953652~exp=1745957252~hmac=9ddabba7c879fe33679900e8c38e3bead006e15e02f8e93edce907e618f90e3c&w=996',
...
export default function FittingsPage() {
  ...
  const fetchItems = async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to fetch fitting items');
      }
      ...
      const normalizedItems = itemsArray.map(item => ({
        ...
        id: item._id || item.id,
        sku: item.sku || item.itemCode || `FITTING-${Math.floor(Math.random() * 100000)}`,
        name: item.name || item.itemName || 'Fitting',
      ...
      console.error("Error fetching fitting items:", error);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h1 className="text-3xl font-bold text-black mb-2">Fittings Inventory</h1>
                <p className="text-gray-800">Manage and track your fittings inventory</p>
              </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <option value="ELBOW">Elbows</option>
                <option value="TEE">Tees</option>
                <option value="COUPLING">Couplings</option>
              ...
              <div className="relative h-48 bg-gray-100">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = 'https://img.freepik.com/free-photo/tools-materials-sanitary-works_93675-132625.jpg?t=st=1745953652~exp=1745957252~hmac=9ddabba7c879fe33679900e8c38e3bead006e15e02f8e93edce907e618f90e3c&w=996';
                  }}
                />
        ...
        {filteredItems.length === 0 && !loading && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No fittings found</h3>
        ...
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-500">Loading fittings...</p>
          </div>
        )}
      </div>
    </div>
