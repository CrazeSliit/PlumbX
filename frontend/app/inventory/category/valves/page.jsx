      ...
      if (storedItems) {
        ...
        if (Array.isArray(parsedItems)) {
          ...
          return valveItems.map(item => ({
            ...
            image: item.image || 'https://img.freepik.com/free-vector/collection-metal-pipes_74855-15365.jpg?t=st=1745953228~exp=1745956828~hmac=28c8dc64ac857f4de496ae3188f2560a64b6bb8448690c0467b179265916e254&w=996',
...
export default function ValvesPage() {
  ...
  const fetchItems = async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to fetch valve items');
      }
      ...
      const normalizedItems = itemsArray.map(item => ({
        ...
        id: item._id || item.id,
        sku: item.sku || item.itemCode || `VALVE-${Math.floor(Math.random() * 100000)}`,
        name: item.name || item.itemName || 'Valve',
      ...
      console.error("Error fetching valve items:", error);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h1 className="text-3xl font-bold text-black mb-2">Valves Inventory</h1>
                <p className="text-gray-800">Manage and track your valves inventory</p>
              </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <option value="GATE">Gate Valves</option>
                <option value="BALL">Ball Valves</option>
                <option value="BUTTERFLY">Butterfly Valves</option>
                <option value="CHECK">Check Valves</option>
              </select>
          <Link
              ...
              <div className="relative h-48 bg-gray-100">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = 'https://img.freepik.com/free-vector/collection-metal-pipes_74855-15365.jpg?t=st=1745953228~exp=1745956828~hmac=28c8dc64ac857f4de496ae3188f2560a64b6bb8448690c0467b179265916e254&w=996';
                  }}
                />
        ...
        {filteredItems.length === 0 && !loading && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No valves found</h3>
        ...
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-500">Loading valves...</p>
        </div>
        )}
      </div>
    </div>
