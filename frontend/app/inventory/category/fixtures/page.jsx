...
export default function FixturesPage() {
  ...
  const fetchItems = async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to fetch fixture items');
      }
      ...
      const normalizedItems = itemsArray.map(item => ({
        ...
        id: item._id || item.id,
        sku: item.sku || item.itemCode || `FIX-${Math.floor(Math.random() * 100000)}`,
        name: item.name || item.itemName || 'Fixture',
        ...
        image: item.image || 'https://img.freepik.com/free-vector/steel-pipes-bolted-connectors-realistic-vector-set_1441-3870.jpg?t=st=1745943878~exp=1745947478~hmac=3b6385bd135623bc98781f55be49249554bcd94549ac2b6d5998446f7ddf1899&w=1060',
      ...
      console.error("Error fetching fixture items:", error);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h1 className="text-3xl font-bold text-black mb-2">Fixtures Inventory</h1>
                <p className="text-gray-800">Manage and track your fixture inventory</p>
              </div>
              ...
              <div className="relative h-48 bg-gray-100">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = 'https://img.freepik.com/free-vector/steel-pipes-bolted-connectors-realistic-vector-set_1441-3870.jpg?t=st=1745943878~exp=1745947478~hmac=3b6385bd135623bc98781f55be49249554bcd94549ac2b6d5998446f7ddf1899&w=1060';
                  }}
                />
        ...
        {filteredItems.length === 0 && !loading && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No fixtures found</h3>
        ...
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-500">Loading fixtures...</p>
          </div>
        )}
      </div>
    </div>
