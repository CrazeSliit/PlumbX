      ...
      if (storedItems) {
        ...
        if (Array.isArray(parsedItems)) {
          ...
          const toolItems = parsedItems.filter(item => 
            item.category === 'tools' || 
            item.category === 'Tools' ||
            (item.name && item.name.toLowerCase().includes('tool'))
          );
...
export default function ToolsPage() {
  ...
  // Fetch items function
    ...
    try {
      setLoading(true);
      const response = await fetch('/api/inventory/category/tools');
      
      if (!response.ok) {
        throw new Error('Failed to fetch tool items');
      }
      ...
      const normalizedItems = itemsArray.map(item => ({
        ...
        id: item._id || item.id,
        sku: item.sku || item.itemCode || `TOOL-${Math.floor(Math.random() * 100000)}`,
        name: item.name || item.itemName || 'Tool',
        ...
        price: Number(item.price || 0),
        image: item.image || 'https://img.freepik.com/free-photo/top-view-mechanical-tools-arrangement_23-2149552380.jpg?t=st=1745948175~exp=1745951775~hmac=b5672a17afab3850aafcc0ae7ba76e0561ecfb7d077dc5be4313d615a84c9470&w=900',
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h1 className="text-3xl font-bold text-black mb-2">Tools Inventory</h1>
                <p className="text-gray-800">Manage and track your tools inventory</p>
              </div>
              ...
              <div className="relative h-48 bg-gray-100">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = 'https://img.freepik.com/free-photo/top-view-mechanical-tools-arrangement_23-2149552380.jpg?t=st=1745948175~exp=1745951775~hmac=b5672a17afab3850aafcc0ae7ba76e0561ecfb7d077dc5be4313d615a84c9470&w=900';
                  }}
                />
